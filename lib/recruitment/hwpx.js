...
// landscape="WIDELY" + 59528×84188 이므로, 가로 구역은 NARROWLY + 폭/높이를 맞바꾼다.
// groupSize: 채점표 한 장에 넣을 지원자 수. 본문 폭이 넓어지는 가로 구역에서만 늘린다.
const PORTRAIT = { landscape: 'WIDELY', width: 59528, height: 84188, margin: 4251, groupSize: 5 };
const LANDSCAPE = { landscape: 'NARROWLY', width: 84188, height: 59528, margin: 4251, groupSize: 8 };
...
function sectionXml(body) {
    ...
    const secPr = '<hp:secPr id="" textDirection="HORIZONTAL" spaceColumns="1134" tabStop="8000" tabStopVal="4000" tabStopUnit="HWPUNIT" outlineShapeIDRef="1" memoShapeIDRef="0" textVerticalWidthHead="0" masterPageCnt="0">'
        ...
        // 세로: WIDELY 59528×84188 / 가로: NARROWLY 84188×59528.
        + `<hp:pagePr landscape="${page.landscape}" width="${page.width}" height="${page.height}" gutterType="LEFT_ONLY"><hp:margin header="0" footer="0" gutter="0" left="${page.margin}" right="${page.margin}" top="${page.margin}" bottom="${page.margin}"/></hp:pagePr>`
