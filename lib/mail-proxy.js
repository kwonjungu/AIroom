const { requestMail } = require('./mail-transport');
...
function createMailProxy(transport = requestMail) {
return async function mailProxy(req, res) {
...
module.exports = createMailProxy();
module.exports.createMailProxy = createMailProxy;
